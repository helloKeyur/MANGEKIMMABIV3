              ...
              <table class="table table-striped data-table" id="user_table">
                ...
                <tbody>
                   ...
                   {{-- @if( Auth::user()->hasRole('admin') ||Auth::user()->hasRole('management') ||Auth::user()->hasRole('headmaster')) --}}
                        ...
                        <a href="javascript:void(0)" class="btn-default edit_user" data-id="{{$row->id}}"  type="button" data-toggle="tooltip" title="Edit User" data-original-title="Edit"><i class="fa fa-pencil" style="color:#3c8dbc"></i></a> &nbsp; | &nbsp;
