      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <a href="javascript:void(0)" class="btn btn-primary btn-block  editTr" data-id="{{ encrypt($vars['user']->id) }}" ><li class="fa fa-pencil-square-o"></li><b>Edit Profile</b></a>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
           ...
           <div class="box-body">
               <form class="prevent-resubmit-form " method="POST" id="asign_role" action="/management/admins/{{ encrypt($vars['user']->id) }}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                     {{ method_field('PATCH') }}
                    <div class="row">
              ...
              <table id="work_station_table" class="table table-bordered table-striped">
                ...
                <div class="tab-pane" id="permissions">
                    <div class="timeline-body">
                        <div class="box">
                            <div class="box-header">
                                <h4 class="timeline-header">Permission For Categories</h4>
                            </div>

                            <div class="box-body">
                                <form class="prevent-resubmit-form" method="POST"  id="add_permission_form" action="/management/admins/{{ encrypt($vars['user']->id) }}" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    {{ method_field('PATCH') }}
                                    <div class="row">
                                        <div class="form-group">
