...
class APIRequest {
	...
	function __construct($context) {
		if ($context != null && get_class($context) != 'App\Vodacom\APIContext') {
	...
	function create_bearer_token() {
		...
		$publickey = PublicKeyLoader::load($this->context->get_public_key()); // $rsa->getPublicKey();
		$api_encrypted = '';
		$encrypted = 'uVl37C9AIeN68fOPZWTX/1Dl1HC8u44pMHIoQOTgfDvtyfLpA+eNhtpR33TeZRXP';
	...
	function create_default_headers() {
		...
		$this->context->add_header('Origin', '3.144.216.126');
	}
